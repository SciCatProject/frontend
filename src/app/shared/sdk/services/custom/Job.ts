...
export class JobApi extends BaseLoopBackApi {
  ...
  public patchOrCreate(
    ...
    let _url: string =
      LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Jobs";
  ...
  public datasetDetails(
    ...
    if (typeof datasetFields !== "undefined" && datasetFields !== null)
      _urlParams.datasetFields = datasetFields;
    if (typeof include !== "undefined" && include !== null)
      _urlParams.include = include;
    if (typeof includeFields !== "undefined" && includeFields !== null)
      _urlParams.includeFields = includeFields;
    let result = this.request(
      _method,
      _url,
      _routeParams,
