...
describe("TableVirtualScrollDataSource", () => {
  ...
  it("should be created", () => {
    const dataSource: TableVirtualScrollDataSource<TestData> =
      new TableVirtualScrollDataSource<TestData>();
    expect(dataSource).toBeTruthy();

    const dataSource2: TableVirtualScrollDataSource<TestData> =
      new TableVirtualScrollDataSource<TestData>([{ index: 0 }]);
  ...
  it("should have reaction on dataOfRange$ changes", () => {
    ...
    const dataSource: TableVirtualScrollDataSource<TestData> =
      new TableVirtualScrollDataSource<TestData>(testData);
