...
export class JobEffects {
  ...
  fetchJobs$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap((params) =>
        this.jobsService.jobsControllerFindAllV4(JSON.stringify(params)).pipe(
          switchMap((jobs) => [
  ...
  fetchJob$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap(({ jobId }) =>
        this.jobsService.jobsControllerFindOneV4(jobId).pipe(
  ...
  submitJob$ = createEffect(() => {
    return this.actions$.pipe(
      ...
      switchMap(({ job }) =>
        this.jobsService.jobsControllerCreateV4(job as any).pipe(
          map((res) =>
