...
export const DEFAULT_CONFIG: AppConfigInterface = {
  additionalConfigs: ["/assets/config.json"],
  ...
  facility: "SciCat FE vanilla",
  siteIcon: "site-header-logo.png",
  siteTitle: "SciCat FE repo",
  siteSciCatLogo: "full",
  siteHeaderLogo: "",
  siteLoginBackground: "",
  siteLoginLogo: "",
  ...
  oAuth2Endpoints: [
    {
      ...
      displayText: "SciCat Vanilla OIDC",
    },
  ],
  ...
  sftpHost: null,
  shareEnabled: true,
  sourceFolder: "/source/data/folder",
  ...
  labelsLocalization: {
    ...
    proposal: {
      ...
      pi_email: "PI Email",
      firstname: "Proposer First Name",
      lastname: "Proposer Last Name",
      email: "Proposer Email",
      endTime: "End Date",
      type: "Type",
      parentProposalId: "Parent Proposal Id",
