...
docker run \
	...
	--additional-properties=ngVersion=18.2.13,npmName=@scicatproject/scicat-sdk-ts-angular,supportsES6=true,npmVersion=10.8.2,withInterfaces=true  --skip-validate-spec
