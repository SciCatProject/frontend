...
describe("Main Page", () => {
  ...
  describe("Main page configuration as non authenticated user", () => {
    it("should visit main page correctly configured", () => {
      ...
      cy.get(
        "div.header mat-toolbar.mat-toolbar.mat-elevation-z1.mat-primary.mat-toolbar-single-row a",
      )
        .eq(0)
      ...
      cy.get(
        "button.mat-mdc-menu-item:nth-child(4) > span:nth-child(2) > span:nth-child(1)",
      ).should("contain", "Published Data");
  ...
  describe("Main page configuration as authenticated user", () => {
    it("should visit main page correctly configured", () => {
      ...
      cy.get(
        ...
        .eq(0)
        .should("have.attr", "href", "/proposals");
      cy.get(
        "div.header mat-toolbar.mat-toolbar.mat-elevation-z1.mat-primary.mat-toolbar-single-row a",
      )
        .eq(1)
