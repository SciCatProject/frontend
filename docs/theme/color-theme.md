...
… Above variables control general theme colors (modify as needed)

-----

⚠️ *NOTE: The 4 variables below currently implemented on the Datasets and Proposals page only*
